Contributing to Cmp Core
============================

The Cmp Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cmp Core project, and is not to be
confused with overall Cmp Network Protocol consensus changes.

Whether a pull request is merged into Cmp Core rests with the project merge
...
Patches that change Cmp consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cmp consensus, it must have been
...
The project leader is the release manager for each Cmp Core release.
