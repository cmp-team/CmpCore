...
RESOURCES += src/qt/cmp.qrc src/qt/cmp_locale.qrc

TRANSLATIONS += src/qt/locale/cmp_bg.ts \
                src/qt/locale/cmp_de.ts \
                src/qt/locale/cmp_en.ts \
                src/qt/locale/cmp_es.ts \
                src/qt/locale/cmp_fi.ts \
                src/qt/locale/cmp_fr.ts \
                src/qt/locale/cmp_it.ts \
                src/qt/locale/cmp_ja.ts \
                src/qt/locale/cmp_pl.ts \
                src/qt/locale/cmp_pt.ts \
                src/qt/locale/cmp_ru.ts \
                src/qt/locale/cmp_sk.ts \
                src/qt/locale/cmp_sv.ts \
                src/qt/locale/cmp_vi.ts \
                src/qt/locale/cmp_zh_CN.ts \
                src/qt/locale/cmp_zh_TW.ts
