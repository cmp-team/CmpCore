...
In order to support loading of multiple wallets in cmp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cmp.cpp.
...
Changes to cmp.cpp
----------------------
cmp.cpp is the entry point into cmp-qt, and as such, will require some minor modifications to provide hooks for
