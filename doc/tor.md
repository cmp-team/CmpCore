...
```
./cmpd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:888
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./cmpd -proxy=127.0.0.1:9050
```
...
your cmpd's P2P listen port (6080 by default).
```
-externalip=X   You can tell cmp about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/cmp-service/hostname. Onion addresses are given
...
```
./cmpd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:888 -listen
```
...
```
./cmpd -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:888 -discover
```
