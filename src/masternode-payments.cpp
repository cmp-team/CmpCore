...
bool IsBlockPayeeValid(const CBlock& block, int nBlockHeight, int nBitsVal)
{
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew, int64_t nFees, bool fProofOfStake)
{
    ...
    CAmount blockValue = GetBlockValue(pindexPrev->nBits, pindexPrev->nHeight);
...
bool CMasternodeBlockPayees::IsTransactionValid(const CTransaction& txNew)
{
    ...
    CAmount nReward = GetBlockValue(nBitsVal,nBlockHeight);
