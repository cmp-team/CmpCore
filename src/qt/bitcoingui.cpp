                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cmp Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cmp address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cmp: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCMP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cmp Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cmp Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cmp"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cmp addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cmp addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cmp: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cmp Core help message to get a list with possible Cmp command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cmp Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cmp network", "", count));
}
...
{
    QString strTitle = tr("Cmp Core"); // default title
