...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextCmp = QChar(0xA9) + QString(" 2019 ").arg(COPYRIGHT_YEAR) + QString(tr("The Cmp Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextCmp);
