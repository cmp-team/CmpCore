                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Cmp from zCmp"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCmp"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCmp));
