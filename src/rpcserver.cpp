...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cmp features */
        {"cmp", "masternode", &masternode, true, true, false},
        {"cmp", "listmasternodes", &listmasternodes, true, true, false},
        {"cmp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cmp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cmp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cmp", "masternodedebug", &masternodedebug, true, true, false},
        {"cmp", "startmasternode", &startmasternode, true, true, false},
        {"cmp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cmp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cmp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cmp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cmp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cmp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cmp", "mnbudget", &mnbudget, true, true, false},
        {"cmp", "preparebudget", &preparebudget, true, true, false},
        {"cmp", "submitbudget", &submitbudget, true, true, false},
        {"cmp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cmp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cmp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cmp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cmp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cmp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cmp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cmp", "checkbudgets", &checkbudgets, true, true, false},
        {"cmp", "mnsync", &mnsync, true, true, false},
        {"cmp", "spork", &spork, true, true, false},
        {"cmp", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cmp", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cmpd, or the -server option to cmp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cmp-cli " + methodname + " " + args + "\n";
}
